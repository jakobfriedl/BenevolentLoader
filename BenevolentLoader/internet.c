...
/*
 * Initialize direct function call structure
 *
 * @param St: Pointer to the structure to fill
 *
...
/*
 * Download shellcode from remote web server
 *
 * @param lpUrl: URL to download from
 * @param pEncShellcode: Pointer to the downloaded shellcode
 * @param pShellcodeSize: Size of the shellcode
 *
 * @returns: TRUE/FALSE if the download succeeded/failed
 */
