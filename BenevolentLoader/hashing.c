...
ULONG HashFNV_1aW(IN LPCWSTR String){
 ...
 /*
  * Custom GetProcAddress that searches for a FNV_1a hash instead
  *
  * @param hModule: Handle to the module to get the function from
  * @param dwApiNameHash: FNV_1a hash of the function to get
  *
...
FARPROC GetProcAddressH(IN HMODULE hModule, IN DWORD dwApiNameHash) {
 ...
 /*
  * Custom GetModuleHandle that searches for a FNV_1a hash instead
  *
  * @param dwModuleNameHash: FNV_1a hash of the module to get
  *
  * @returns: TRUE/FALSE if succeeded/failed
  */
...
/*
 * Helper function to print API hashes
 */
VOID PrintHashes() {
